  ...
  */
  ...
  public updateStandardTranslations(): Observable<boolean> {
    return this.getTranslations([
      ...
      new TranslationInput('ANGULAR.REGISTER_AGENT_DESCRIPTION_3', []),
      new TranslationInput('ANGULAR.REGISTER_AGENT_DESCRIPTION_4', []),
      new TranslationInput('ANGULAR.REGISTER_AGENT_DESCRIPTION_5', []),
      new TranslationInput('ANGULAR.REGISTER_AGENT_DESCRIPTION_6', []),
      ...
      new TranslationInput('MIRROR_MODE.RUNNING', []),
