...
export class TranslationService {
  ...
  public static updateStandardTranslations(): boolean {
    let translations: any = TranslationService.getTranslations([
      ...
      new TranslationInput('ELECTRON.DATABASE_MIRROR', []),
      ...
      new TranslationInput('ELECTRON.SERVER_COMMUNICATION.MESSAGES.WARN', []),
      ...
      new TranslationInput('ELECTRON.SERVER_COMMUNICATION.MESSAGES.SEND_REQUEST_OK', []),
      ...
      new TranslationInput('QUERIES.MESSAGES.IMPORT_NO_DATA_WARNING', []),
      ...
      new TranslationInput('SCRIPTS.MESSAGES.IMPORT_NO_DATA_WARNING', []),
