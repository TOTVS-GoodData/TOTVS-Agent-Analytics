...
export class TranslationService {
  ...
  public static updateStandardTranslations(): boolean {
    let translations: any = TranslationService.getTranslations([
      ...
      new TranslationInput('ELECTRON.SERVER_COMMUNICATION.MESSAGES.SERIAL_NUMBER', []),
      new TranslationInput('ELECTRON.SERVER_COMMUNICATION.MESSAGES.SERIAL_NUMBER_OK', []),
      new TranslationInput('ELECTRON.SERVER_COMMUNICATION.MESSAGES.SERIAL_NUMBER_ERROR', []),
