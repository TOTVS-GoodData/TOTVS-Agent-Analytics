export const CNST_TRANSLATIONS_ES_ES: any = {
  ...
  QUERIES: {
    ...
    MESSAGES: {
      ...
      IMPORT_NO_DATA: 'Ninguna información recibida del servidor del TOTVS.',
      IMPORT_NO_DATA_WARNING: 'Atención - Ninguna información disponible para la importación. Por favor entre em contacto con el equipo de soporte.',
